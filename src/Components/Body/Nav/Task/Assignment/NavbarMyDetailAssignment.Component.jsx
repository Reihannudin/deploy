...
export const NavbarMyDetailAssignmentComponent = (props) => {
                    ...
                    <div className="flex  justify-between gap-4"  style={{maxWidth:"1500px",}}>
                        <div className="flex gap-4">
                            ...
                            <div className="my-2 font16-res-400 text-left" >
                                <h4 className=" font16-res-400 w-44 border-radius-4 ">
                                    {props.name}
                                </h4>
                                <p className="font14-res-300 w-44 text-purple-700 border-radius-4 " >
                                    {classname}
                                </p>
                                    ...
                                    <div style={{ fontSize:"16px"}} className="font-medium font16-res-300 mt-1">
                                        <ul className="list-none gap-6 flex" style={{ fontWeight :"500"}}>
                                            <li className="pe-6 my-auto" style={{ borderRight:"1px solid #ebebeb"}}>
                                                <Link  style={{ fontWeight:"500"}} className={` ${isDetailClassActive ? 'text-purple-600' : 'text-gray-400'}  my-0 relative cursor-pointer hover:text-purple-600 font`} to={`/view/${slug}/${class_id}/my/assignment/${id}`}>Tugas
                                            ...
                                            <li className="pe-6 my-auto" style={{ borderRight:"1px solid #ebebeb"}}>
                                                <Link style={{ fontWeight:"500"}}  className={` ${isStudentActive ? 'text-purple-600' : 'text-gray-400'}  my-0 relative cursor-pointer hover:text-purple-600 font`} to={`/view/${slug}/${class_id}/my/assignment/${id}/students`}>Student
                                                    <div className="w-full mx-auto  absolute top-2 my-3  h-1 cursor-pointer hover:bg-purple-400  block hover:scale-x-50 transform origin-center  transition-transform duration-300">
                                                    </div>
                                                </Link>
                                            </li>
                        ...
                        <div className="lg:hidden lg:w-full relative flex items-center w-auto sm:flex sm:items-center sm:w-auto md:flex md:items-center md:w-auto">
                            ...
                            >
                                <li className="pt-8 pb-4">
                                    <Link  className={` ${isDetailClassActive ? 'text-purple-600' : 'text-gray-400'}   text-purple-400  cursor-pointer hover:text-purple-600`} to={`/view/${slug}/${class_id}/my/assignment/${id}`}>Tugas
                                ...
                                <li className="py-4">
                                    <Link  className={`   ${isStudentActive ? 'text-purple-600' : 'text-gray-400'}  cursor-pointer hover:text-purple-600`}  to={`/view/${slug}/${class_id}/my/assignment/${id}/students`}>Student
                                        <div className="w-1/12 mx-auto h-1 cursor-pointer hover:bg-purple-400  block hover:scale-x-50 transform origin-center  transition-transform duration-300">
                                        </div>
                                    </Link>
                                </li>
