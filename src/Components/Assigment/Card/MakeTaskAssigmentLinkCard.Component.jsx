...
export const MakeTaskAssigmentLinkCardComponent = (props) => {
    ...
    const handleFileInputChange = (event) => {
        ...
        const answer = file.name; // Use file.name to get the file name
        setAnswer(answer);
        props.onQuestionChange({ trueAnswer: answer });
    };
