...
export const NavbarPreAssignmentEmptyComponent = () => {
    ...
    const isDetailClassActive = location.pathname === `/view/${slug}/${class_id}/absent/${id}`
    const isStudentActive = location.pathname === `/view/${slug}/${class_id}/absent/${id}/classmate`
    ...
    return(
        <>
            <nav className="w-full fixed  bg-white" style={{  zIndex:"44" , minWidth:"333px" , borderBottom:"1px solid #E5E3E9"}}>
                <header className=" xl:w-10/12 w-11/12 py-2  mx-auto">
