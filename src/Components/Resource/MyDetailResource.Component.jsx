...
import {ResoruceCardComponent} from "./Card/ResoruceCard.Component";

export const MyDetailResourceComponent = (props) => {
                            ...
                            <div className="text-left lg:w-full w-11/12 mx-auto mt-1 mb-6">
                                <div className=" w-full  mx-auto pb-3">
                                    <div className="mt-2 sm:mx-5 mx-2.5  text-gray-500 flex gap-2">
                                        ...
                                        <p className="my-0 py-0  font13-res-300" >{props.post_time}</p>
                                    </div>
                                    <div className="block my-0 sm:mx-5 mx-2.5  text-gray-700  gap-4 w-full  ">
                                        <p className="mb-2 mt-1 font14-res-300 text-gray-500" >
                                            {extractedText}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="block pt-3 gap-4 mx-auto  lg:mx-5 w-full  ">
                                    <ul className="pt-1 md:grid md:grid-cols-2  mx-auto   w-full block">
                                        {url.map((item) => {
                                            return(
                                                <li key={item.id} className="w-full lg:w-full md:w-11/12 my-3">
                                                    <div>
                                                        <ResoruceCardComponent name={item.name} link={item.link} />
                                                    </div>
                                                </li>
                                            )
                                        })}
