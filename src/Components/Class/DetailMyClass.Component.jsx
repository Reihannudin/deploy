...
//     return(
//         <>
//             <div  key={props.id} className='h-full min-h-screen  mx-auto lg:pt-16 md:pt-7  sm:pt-7 pt-7 px-0 ' style={{ minWidth:"280px" , maxWidth:"1500px"}}>
//                 <div className="block w-full md:hidden">
//                     <MyDetailClassNavComponent />
//                 </div>
//                 <div className="lg:flex lg:py-0 md:py-8 py-2 md:block xl:w-10/12 lg:w-11/12 w-full mx-auto lg:justify-between">
//                     <div className="xl:w-10/12 w-full sm:w-11/12 mx-auto lg:my-0 my-5 lg:w-9/12">
//                         <div className="w-full lg:py-6 py-3 text-left  lg:mb-0 md:mb-0 bg-white">
//                                         <h2 className="font30-res-300 mx-5">{props.name}</h2>
//                                         <div className="text-left flex border-b mb-4 md:mb-0 border-gray-200 pb-5 justify-between mx-5">
//                                             <div className="block">
//                                                 <h2 className="font14-res-300 text-gray-700" >Guru : {props.teacher}</h2>
//                                                 <h2 className="font14-res-300 text-gray-700">Ruang : {props.room}</h2>
//                                             </div>
...
//                                         </div>
//                         </div>
//                         <div className="lg:w-10/12 md:w-8/12 lg:hidden w-10/12 bg-white pb-4 sm:pb-3 md:pb-2 flex mx-auto border-radius-4">
//                                             <input
//                                                 ref={inputRefCode}
//                                                 className="font16-label-res-400 py-2 px-3 bg-gray-100 w-10/12"
//                                                 value={props.code}
//                                                 readOnly
//                                             />
//                                             <button className="w-2/12 bg-purple-500 hover:bg-purple-700 cursor-pointer" onClick={copyText}>
//                                                 <img className="my-auto w-full h-icon-copy" src="/assets/copy-icon.svg" alt="Copy" />
//                                             </button>
//                                             <button onClick={handleUpdateClassCode} className="w-2/12 bg-white hover:bg-gray-50 cursor-pointer border border-purple-600">
//                                                 <img className="my-2 w-full h-icon-copy" src="/assets/change-code.svg" alt="Change Code" />
//                                             </button>
//                                         </div>
//                         <div className="lg:w-10/12 w-full lg:hidden block lg:shadow border-t  border-b mx-auto ">
//                             <div className="m-6-c-detail">
//                                 <div className="pt-5 w-11/12 mx-auto  md:w-full  text-left ">
//                                     <h4 className="font16-res-400 ">Keleolah History anda</h4>
//                                 </div>
//                                 <div className="font14-res-300">
//                                     <div className="flex gap-5 justify-between  px-6 pt-6">
...
//                                             onClick={() => handleDayClick(day, index)}
//                                         >
//                                             <div className="font15-input-res-300" style={{ fontWeight:"550"}}>{daysOfWeek[index]}</div>
//                                             <div className="font14-label-res-300">{day.getDate()}</div>
//                                         </div>
//                                     )
//                                 })}
//                             </div>
...
//                                 <div className="w-11/12 ">
//                                     <ul id="tabs" className="flex mt-1  font18-res-300 w-8/12 px-1 text-purple-500">
//                                         <li className="pe-3 sm:pe-6 w-full text-gray-500 hover:text-purple-600 text-left font16-res-400 py-2">
//                                             <a id="default-tab" href="#absent" className="w-full" onClick={() => handleTabClick('absent')}>
//                                                 Absent
//                                             </a>
//                                         </li>
//                                         <li className="px-3 sm:px-6 w-full text-gray-500 hover:text-purple-600 text-left mx-4 font16-res-400  py-2">
//                                             <a href="#assignment" className="w-full" onClick={() => handleTabClick('assignment')}>
//                                                 Tugas
//                                             </a>
//                                         </li>
//                                         <li className="px-3 sm:px-6 w-full text-gray-500 hover:text-purple-600 text-left font16-res-400  py-2">
//                                             <a href="#resource" className="w-full" onClick={() => handleTabClick('resource')}>
//                                                 Resource
//                                             </a>
//                                         </li>
