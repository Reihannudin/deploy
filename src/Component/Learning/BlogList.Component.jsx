import {NewsCardComponent} from "../Card/NewsCard.Component";
                        ...
                        <div className="mt-10 ">
                            <div className="xl:w-10/12 w-11/12 mx-auto md:flex md:justify-between block">
                                <div className="flex  lg:me-0 me-auto xl:w-4/12 lg:w-5/12 md:w-5/12 w-full ">
                                   <div className="flex  w-full">
                                       <div className="lg:w-10/12 w-full font15-res-300">
                                           <input className="bg-white text-gray-500 border border-gray-100 font15-res-300 px-3 py-1.5 xl:py-2 w-full" onChange={onChangeSearch} placeholder="Cari materi" type="text" />
                                       </div>
                                       <div className="lg:w-2/12 ">
                                           <button onClick={() => handleSearchArticle(search)} className="btn py-1 border  bg-purple-600 text-white lg:block border-purple-600  sm:px-5 md:px-2 px-4 lg:px-1 xl:py-2 xl:px-2 " style={{ borderRadius:"0px 4px 4px 0px"}}>
                                               <div className="my-auto " style={{ height:"23px"}}>
                                                   <img className="h-full w-full" src="/assets/search-icon-gray.svg"/>
                                               </div>
                                            </button>
                                       </div>
                                   </div>
                                ...
                                <div className="flex lg:w-6/12">
                                    <div className="flex gap-3 md:my-0 my-4  lg:w-10/12 w-9/12">
                                    <div className="flex gap-2 ms-0 md:ms-auto scrollbar-hide overflow-x-auto">
                                        {categories.map((item) => {
                                            return(
                                                <>
                                                    <div className="flex-shrink-0 " key={item.id}>
                                                        <div className="border-radius-20 px-3  hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-purple-600 lg:py-1.5  lg:px-4 lg:my-1.5 py-1.5 border">
                        ...
                        <div className='relative lg:w-full w-11/12  mx-auto flex mt-6 items-center'>
                            <div className=" xl:w-11/12 lg:w-full md:w-full sm:w-11/12 w-full mx-auto relative">
                                ...
                                <div className="lg:w-11/12 w-full flex mx-auto">
                                        {articles.length === 0 ? (
                                            <div className="sm:gap-3 gap-1 py-8  mx-auto    flex flex-wrap  ">
                                                ...
                                                {articles.map((item) => {
                                                    return(
                                                        <div className=" mx-0 sm:mx-0  w-res-card-news sm:w-full" key={item.id} style={{ minWidth:"215px" , maxWidth:"400px"}}>
                                                            <NewsCardComponent id={item.id} slug={item.slug} title={item.title} subject_category={item.subject_category}/>
                                                        </div>
                                                    )
                                                })}
                                            </div>
                        ...
                        <div className=" border-t mt-8 w-full">
                            <div className="w-7/12 py-2 mx-auto">
                                <div className="flex w-full font14-res-300 justify-center mt-4">
                                    {/* Previous button */}
                                    <button
                                        className="mx-1 px-1.5 py-1 rounded-full bg-gray-50"
                                    ...
                                    {pageNumbers.map((number) => (
                                        <button
                                            key={number}
                                            className={`mx-1 px-2.5 py-0.5 rounded-full ${
