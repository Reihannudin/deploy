...
export const MyProfileComponent = ({user , isDataFetched , isFetching  }) => {
                            ...
                            <div className="w-full">
                                <div className="relative  my-0">
                                    <div className="h-profile-banner-new mb-3" style={{ width:"100%"}}>
                                        <img className="w-full object-cover h-full md:border-radius-8 border-none h-profile-banner-new"
                                    ...
                                    <div className="absolute xl:left-28 lg:left-20 lg:top-48 md:top-40 sm:top-36 top-24 md:left-12 sm:left-10 left-3">
                                        <div className="radius-100 bg-white p-1 h-profile-round-new" >
                                            {isFetching ? (
                                                <img className="w-full h-full radius-100 bg-gray-200 animate-pulse" style={{ objectFit:"cover"}}
                                                    // src="https://64.media.tumblr.com/c4261c6b86206032f5000e9ac0169402/a1d478c0246b8aed-ea/s1280x1920/6906370fc985067d21fd57b6df97d42c000c547d.jpg"
                                                />
                                            ) : !isDataFetched ? (
                                                <img className="w-full h-full radius-100  bg-gray-200 animate-pulse" style={{ objectFit:"cover"}}
                                                    // src="https://64.media.tumblr.com/c4261c6b86206032f5000e9ac0169402/a1d478c0246b8aed-ea/s1280x1920/6906370fc985067d21fd57b6df97d42c000c547d.jpg"
                                                ...
                                                <img className="w-full h-full radius-100" style={{ objectFit:"cover"}}
                                                     src={user.image}
                                                    // src="https://64.media.tumblr.com/c4261c6b86206032f5000e9ac0169402/a1d478c0246b8aed-ea/s1280x1920/6906370fc985067d21fd57b6df97d42c000c547d.jpg"
                                                />
                                            )}
                                ...
                                <div className="ms-auto ms:me-4 me-0 sm:w-3/12 w-5/12 " >
                                    <div className="lg:my-2 md:my-1 sm:my-4 my-1">
                                        <button  onClick={() => window.location.href='/edit/profile'} className="font14-res-300 border py-1.5 text-gray-500 bg-white px-4 border-gray-400 hover:bg-purple-600 hover:text-white border-radius-20" style={{ fontWeight:"500"}}>
                                            Edit profile
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="lg:w-11/12 lg:my-8 sm:my-3 my-0 py-4 w-full mx-auto lg:bg-transparent bg-white ">
                                {isFetching ? (
                                    <div className="text-left  xl:ms-6 xl:me-6 lg:ms-auto lg:me-0 md:ms-7 md:me-7  ms-4 me-4 lg:mt-0 md:mt-0 mt-0 md:mb-4 mb-2">
                                        <h1 className="font16-res-400  w-44 border-radius-4 bg-gray-200 py-2 my-1 animate-pulse"></h1>
                                        <p className="font14-res-300  w-44 border-radius-4 bg-gray-200 py-1.5 my-1 animate-pulse" style={{ color:"#7a7a7a" , fontWeight:"450"}}></p>
                                        <div className="my-2">
                                            <p className="font16-res-300 md:font18-res-300  w-44 border-radius-4 my-1bg-gray-200 py-1 animate-pulse" style={{  color:"#595959"}}></p>
                                        </div>
                                        <div className="mt-1 border-t pt-3 mb-2">
                                            <div className="block ">
                                                <div className="flex  py-1 gap-1">

                                                    <p className="font14-res-300 w-44 border-radius-4 my-1 bg-gray-200 py-1.5 animate-pulse text-gray-500"></p>
                                                </div>
                                                {user.address === null? (
                                                    <>
                                                    </>
                                                    ...
                                                    <div className="flex  py-1 gap-1">
                                                        ...
                                                        <p className="font13-res-300 w-44 border-radius-4 bg-gray-200 py-1.5 animate-pulse text-gray-500 text-gray-500"></p>
                                                    </div>
                                                )}

                                                <div className="flex  py-1   gap-1">

                                                    <p className="font13-res-300  text-gray-500 w-44 border-radius-4 my- 1bg-gray-200 py-1.5 animate-pulse text-gray-500"></p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="font16-res-400">
                                                <button>
                                                    <div className="flex gap-1">
                                                        <p className={"font15-res-300"} style={{ fontWeight:"550", color:"#4f4e4e"}}>0</p>
                                                        <p className={"font15-res-300"} style={{ fontWeight:"400" , color:"#9a9999"}}>Mengikuti</p>
                                                    </div>
                                                </button>
                                            </div>
                                            <div className="font16-res-400">
                                                <button>
                                                    <div className="flex gap-1">
                                                        <p className={"font15-res-300"} style={{ fontWeight:"550" , color:"#4f4e4e"}}>0</p>
                                                        <p className={"font15-res-300"} style={{ fontWeight:"400" , color:"#9a9999"}}>Pengikut</p>
                                                    </div>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className="text-left  xl:ms-6 xl:me-6 lg:ms-auto lg:me-0 md:ms-7 md:me-7  ms-4 me-4 lg:mt-0 md:mt-0 mt-0 md:mb-4 mb-2">
                                        <h1 className="font16-res-400" style={{ fontWeight:"550"}}>{user.name}</h1>
                                        <p className="font14-res-300 " style={{ color:"#7a7a7a" , fontWeight:"450"}}>@{user.username}</p>
                                        <div className="my-2">
                                            <p className="font16-res-300 md:font18-res-300" style={{  color:"#595959"}}>{user.bio}</p>
                                        </div>
                                        <div className="mt-1 border-t pt-3 mb-2">
                                            <div className="block ">
                                                <div className="flex  py-1 gap-1">
                                                    ...
                                                    <p className="font14-res-300  text-gray-500">{user.school}</p>
                                                </div>
                                                {user.address === null? (
                                                    <>
                                                    </>
                                                    ...
                                                    <div className="flex  py-1 gap-1">
                                                        ...
                                                        <p className="font13-res-300  text-gray-500">{user.address}</p>
                                                    </div>
                                                )}
                                                ...
                                                <div className="flex  py-1   gap-1">
                                                    ...
                                                    <p className="font13-res-300  text-gray-500">Bergabung Pada {user.join_date}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="mt-2 flex gap-4">
                                ...
                                <div className=" z-50 w-full ms-auto ">
                                    <div className=" bg-white w-full  border-radius-4 pt-1.5  ">
                                        <ul id="tabs" className="flex  w-full px-1  text-purple-500">
                                            ...
                                            <li className=" px-0 w-11/12 font16-res-400 text-gray-500 hover:text-purple-600  mx-4 py-2 " style={{ fontWeight:"500"}}>
