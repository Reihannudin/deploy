  ...
  return (
    <>
      <div
        ...
        style={{ zIndex: "44", minWidth: "300px" }}
      >
        <div
          className="sm:mx-auto mx-0 pb-2  poppins  lg:pb-2 pt-1 flex  w-full"
          style={{ borderBottom: "1px solid #E5E3E9", maxWidth: "1500px" }}
        >
            ...
            >
              <div className="w-full justify-between flex">
                  ...
                  <a href="#">
                    <div className="mt-2 mb-2" style={{ height: "36px" }}>
                      <img
                        ...
                        src="/assets/spaceskool-logo-bg.svg"
                        alt=""
                      />
                    </div>
                  </a>
                ...
                <div className="flex justify-between ">
                  ...
                  <div
                    className="  mx-16 w-full lg:flex hidden my-auto  lg:items-center lg:w-auto"
                    id="menu"
                  >
                    <div className="flex gap-4 my-auto ">
                      ...
                      >
                        <ul
                          className="list-none gap-6 flex"
                          style={{ fontWeight: "500" }}
                        >
                          <li
                            className="pe-6 my-auto text-purple-500"
                            style={{ borderRight: "1px solid #ebebeb" }}
                          >
                            <Link
                              to={"/"}
                              style={{ fontWeight: "500" }}
                              className=" text-gray-400 my-0 relative cursor-pointer hover:text-purple-600 font"
                            >
                              Beranda
                              <div className="w-full mx-auto  absolute top-2 my-3  h-1 cursor-pointer hover:bg-purple-400  block hover:scale-x-50 transform origin-center  transition-transform duration-300"></div>
                            </Link>
                          </li>
                          <li
                            className="pe-6 my-auto"
                            style={{ borderRight: "1px solid #ebebeb" }}
                          >
                            <Link
                              to={"/learning"}
                  ...
                  {logged === true ? (
                    <div className="my-auto flex gap-3">
                      <li className="my-auto relative mt-1 list-none">
                        <button
                          ...
                          style={{ fontSize: "14px" }}
                          data-dropdown-toggle="dropdown_profile"
                        ...
                        <div
                          ...
                          } absolute left-0 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
                        >
                          <ul
                            className="py-2 text-sm text-left text-gray-700 dark:text-gray-400"
                    ...
                    <div className="my-auto lg:flex hidden gap-2 md:gap-1">
                      ...
                      <button
                        className="btn  lg:block border-radius-20 bg-white hover:bg-purple-600 font-medium weverse-color hover:text-white sm:px-5 px-4 lg:px-5 xl:px-6 py-1"
                        style={{ border: "1px solid #AC7EEE" }}
                      >
                        <Link to="/register">
        ...
        <div
          id="menu"
          className={`h-full menu ${isMenuHidden ? "hidden" : ""}`}
        >
              ...
              >
                ...
                <li className="pb-3">
                  <div className="my-auto w-6/12 mx-auto block gap-2 md:gap-1">
                    ...
                    <div className="my-3">
                      <button
                        className="btn  lg:block sm:px-5 px-4 border-radius-4 w-10/12 py-1"
                        style={{ border: "1px solid #AC7EEE" }}
                      >
                        <Link to="/register">
                          <p
                            className="font-medium weverse-color"
                            style={{ fontSize: "14px" }}
                          >
                            Sign Up
                          </p>
