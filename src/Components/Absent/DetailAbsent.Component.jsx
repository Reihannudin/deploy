    ...
    return(
        <>
            <div className='h-full  mx-auto md:pt-16  pt-14 px-0' style={{ minWidth:"333px"}} key={props.id} >
                ...
                <div className="lg:flex md:block relative h-full gap-2 md:gap-4 lg:w-11/12  w-full mx-auto lg:justify-between">
                    <div className="xl:w-8/12 md:w-11/12 mx-auto lg:w-9/12 w-full">
                        <div className="bg-white">
                            <div className="me-auto   md:w-11/12 border-b lg:w-full w-11/12 mx-auto">
                                <div className="w-11/12 md:mx-6 mt-4 mb-0 ">
                                    <ul id="tabs" className="flex mt-1  font18-res-300 w-10/12 px-1 text-purple-500">
                                        <li className="pe-6  text-gray-500 hover:text-purple-600 text-left font15-res-300 py-2">
                                            <a id="default-tab" href="#absent" className="w-full" onClick={() => handleTabClick('absent')}>
                                                Absent
                                            </a>
                                        </li>
                                        <li className="px-6 text-gray-500 hover:text-purple-600 text-left mx-4  font15-res-300 py-2">
                        ...
                        <div id="tab-contents" className="w-full md:w-11/12 lg:w-full lg:mx-3 mx-auto">
                            ...
                            <div id="classmate" className={`py-2 lg:px-4 ${activeTab === 'classmate' ? '' : 'hidden'}`}>
                                <div className={"my-3 "}>
                                    <div className="md:w-full mx-auto sm:w-11/12  w-11/12">
                                    ...
                                    <>
                                        {itemAction.username === username ? (
                                            <div className="shadow md:shadow-none lg:shadow lg:pb-4 pb-3 border-radius-8">
                                                <div className="flex lg:mx-4 lg:w-11/12 md:w-full w-11/12 mx-auto py-5 justify-between">
