                                            ...
                                            <div className="sm:flex block  w-full text-left " >
                                                <div className="mt-3 w-full mx-auto">
                                                    ...
                                                    <div className="flex md:w-11/12 w-full">
                                                        <input id="class" onChange={onChangeName} required  type="text" className="md:w-11/12 w-full py-1.5 md:py-2.5 font15-res-300 border-b-gray-300" style={{ borderBottom:"1px solid #ebebeb"}} placeholder="Nama Kelas"/>
                                                    </div>
                                                    {errorName === '' ? (
                                                        <div className="my-2">
                                                        </div>
                                                ...
                                                <div className="mt-3 w-full mx-auto">
                                                    ...
                                                    <div className="flex md:w-11/12 w-full">
                                                        <input id="room" onChange={onChangeRoom} required type="text" className="md:w-11/12 w-full py-1.5 md:py-2.5 font15-res-300 border-b-gray-300" style={{ borderBottom:"1px solid #ebebeb"}} placeholder="Nama Ruang"/>
                                                    </div>
                                                    {errorRoom === '' ? (
                                                        <div className="my-2">
                                                        </div>
                                        ...
                                        <div className="sm:flex block w-full text-left ">
                                            <div className="sm:flex block  w-full text-left ">
                                                <div className="mt-3 w-full mx-auto">
                                                    ...
                                                    <div className="flex  md:w-11/12 w-full">
                                                        <input id="section" required onChange={onChangeSection}  type="text" className="md:w-11/12 w-full py-1.5 md:py-2.5 font15-res-300  border-b-gray-300" style={{ borderBottom:"1px solid #ebebeb"}} placeholder="Nama Jurusan"/>
                                                    </div>
                                                    {errorSection === '' ? (
                                                        <div className="my-2">
                                                        </div>
                                                ...
                                                <div className="mt-3 w-full mx-auto">
                                                    ...
                                                    <div className="flex md:w-11/12 w-full">
                                                        <input id="subject" required onChange={onChangeSubject} type="text" className="md:w-11/12 w-full py-1.5 md:py-2.5 font15-res-300  border-b-gray-300" style={{ borderBottom:"1px solid #ebebeb"}} placeholder="Nama Mata Pelajaran"/>
                                                    </div>
                                                    {errorSubject === '' ? (
                                                        <div className="my-2">
                                                        </div>
                                        ...
                                        <div className="mt-3  xl:w-7/12 lg:w-8/12 md:w-9/12 sm:10/12  w-full text-left ">
                                            ...
                                            <div className="flex w-full">
                                                <div className="flex w-full my-3 items-center">
                                                    ...
                                                    />
                                                    <span className="font15-res-300 ml-4" style={{ color:"#777575" }}>{rangeStudent}</span>
                                                </div>
                                            </div>
                                            {errorMaxStudent === '' ? (
                                                <div className="my-2">
