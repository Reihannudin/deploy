                    ...
                    <div className="block w-11/12">
                        <div className="flex me-2 md:me-5 justify-between">
                            <div className="block w-7/12">
                                <div className="w-10/12 mx-1 mt-0 md:mt-0.5 text-left">
                                ...
                                <div className="w-full  block   mt-1 gap-2  mx-1 text-left">
                                    <div className=" flex gap-2  text-left">
                                        ...
                                        {props.status === null ? (
                                            <p className="font13-res-300" style={{ fontWeight: "550", color: "#605f5f" }}>Belum selesai</p>
                                        ) : (
                                            <p className="font13-res-300" style={{ fontWeight: "550", color: "#605f5f" }}>{props.status}</p>
                                        )}
                                    </div>
                                    <div className=" flex  gap-2  text-left">
                                        <p className="text-gray-600  text-right font13-res-300">Waktu pengerjaan :</p>
                                        <p className="font13-res-300  text-right text-gray-600">
                                            {props.intime === null ? '-' : props.intime}
                                        </p>
                                    </div>
                            ...
                            <div className="block gap-2">
                                <div className="w-full text-right  block">
                                   <div className="mx-auto mt-1 md:mt-1 mb-1 ">
                                       <p className="mx-auto font13-res-300 text-gray-600" >
                                           Score : {props.score === null ? 'Tidak ada' : props.score}
                                       </p>
                                   </div>
                                </div>
