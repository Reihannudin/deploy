                                        ...
                                        <div className=" w-11/12  pt-2 mx-auto pb-3">
                                            <div className="block pt-3 gap-4 ">
                                                ...
                                                <div className="flex my-2">
                                                    ...
                                                    <p className="my-0 mx-2 font14-res-300  bg-gray-200 w-10 animate-pulse" ></p>
                                                </div>
                                            </div>
                                            <div className="flex my-2">
                                                <label className="my-0 py-0 font14-res-300" >Diizinkan melakukan absent : </label>
                                                <p className="my-0 mx-2 font14-res-300  bg-gray-200 w-7 animate-pulse" ></p>
                                            </div>

                                            <div className="my-2">
                                                <label className="my-0 py-0 font14-res-300" >Batas Waktu Absent</label>
                                                <p className="my-0 py-1 font14-res-300  bg-gray-200 w-40 animate-pulse" ></p>
                                            </div>
                                        </div>
                                        <hr />
